...
##############################
caseName <- 'HCRA - 0.24/1.8e06'

# load object
load(file.path(outPath,'1000_iter','NSAS_Ftar_0.24_Btrig_1800000_HCR_A_TACIAV__BB__200iters.RData.RData'))
...
risk200 <- max(SSB_prob)

# 1000 iterations
load(file.path(outPath,'1000_iter','NSAS_Ftar_0.24_Btrig_1800000_HCR_A_TACIAV__BB__1000iters.RData.RData'))
...
legend("topright",
       c(paste0("200 iter - risk = ",risk200),
         paste0("1000 iter - risk = ",risk1000)),
