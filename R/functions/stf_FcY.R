...
stf_FcY <- function(stf,
  ...
  r<- foreach(idxIter=1:nits) %dopar% {nls.lm(  par=runif(4), # starting point
                                                ...
                                                stock.wt_sf = iter(stf@stock.wt[,FcY,1],idxIter),
                                                M           = iter(stf@m[,,1],idxIter),
                                                M.spwn      = iter(stf@m.spwn[,,1],idxIter),
                                                F.spwn      = iter(stf@harvest.spwn[,,1],idxIter),
                                                mats        = iter(stf@mat[,,1],idxIter),
                                                TACs        = iter(TAC,idxIter),             
